                ...
                <table className="table table-striped my-4 w-100">
                  ...
                  <tbody>
                    ...
                    <tr className="gradeC">
                      ...
                      <td className="no-display">Mar 6, 2020</td>
                      <td className="no-display">2:06 pm</td>
                      <td className="no-display sign-out">
                        <button
                          data-test-entry-feed-sign-out=""
                          className="log-btn log-btn--smaller log-btn--brandHoverFill print-display-none"
                          type="button"
                        >
                          Sign out
                        </button>
